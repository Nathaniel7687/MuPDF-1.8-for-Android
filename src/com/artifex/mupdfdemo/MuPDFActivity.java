...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (core == null) {
            ...
            intent.setAction(Intent.ACTION_VIEW);       // ChoosePDFActivty.java에서 따옴
            byte buffer[] = null;

            if (Intent.ACTION_VIEW.equals(intent.getAction())) {
//				Uri uri = intent.getData();
                Uri uri = Uri.parse("/storage/emulated/0/Download/ise-deployment-technology-paper-tp627-1-1203kr.pdf");
